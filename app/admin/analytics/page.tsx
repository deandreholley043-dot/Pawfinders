...
const coreStats = [
  { label: "Unique Visitors", value: "11,000", icon: Eye, color: "#ec4899" },
  { label: "Total Page Views", value: "28,720", icon: BarChart3, color: "#f472b6" },
  { label: "Bounce Rate", value: "34.2%", icon: ArrowDownUp, color: "#ffa726" },
  { label: "Avg. Time on Site", value: "3m 24s", icon: Clock, color: "#ab47bc" },
  { label: "Sessions", value: "14,260", icon: MousePointer, color: "#ec407a" },
]
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Monitor site traffic, user engagement, conversions, and compliance.
        </p>
      </div>

      {/* Core Stat Cards - always visible */}
